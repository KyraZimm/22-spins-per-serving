...
public class Spawner : AttackScript
{
    ...
    private void SpawnProjectile(float angle, float age)
    {
        ...
        //projectile.transform.rotation = Quaternion.LookRotation(dir); //don't need this line for now, but if we add oblong or asymmetric sprites, this should rotate them in the correct direction
